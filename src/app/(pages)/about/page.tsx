  ...
  return (
    <div>
      <section className='flex flex-col min-h-screen'>
        <div className='mx-auto max-w-7xl flex-1 px-10'>
          <div className='grid grid-cols-1 md:grid-cols-2 gap-10 flex-1 md:min-h-[calc(100vh_-_71px)]'>
            <div className='flex flex-col mb:flex-1 items-center justify-center text-center my-10 md:my-0'>
              <h2 className='text-4xl text-center font-bold text-black dark:text-white py-5'>
                Cross-Cultural Requirements?
              </h2>
              <p className='text-lg font-normal text-gray-500 dark:text-white max-w-md md:max-w-2xl mx-auto'>
                At EthicCheck, we make sure your website is ready to jet-set around the world by
                checking for specific cultural requirements in different countries. Let's make sure
                your online presence is always in tune with the global vibe!
              </p>
            </div>
            <div className='flex flex-col flex-1 gap-x-2 items-center justify-center gap-y-5 text-justify md:py-10'>
              <p className='text-neutral-500 dark:text-neutral-300'>
                In today's interconnected world, where the internet knows no boundaries, ensuring
                that your website is culturally sensitive and inclusive is more important than ever.
                Websites are accessed by people from diverse backgrounds, cultures, and languages,
                and overlooking cultural considerations can lead to misunderstandings,
                misinterpretations, and ultimately, missed opportunities.
              </p>

              <p className='text-neutral-500 dark:text-neutral-300'>
                Cultural differences influence how people perceive and interact with websites. By
                considering cross-cultural requirements, you can ensure that your website resonates
                with audiences worldwide, enabling you to reach and engage with a broader
                demographic.
              </p>

              <p className='text-neutral-500 dark:text-neutral-300'>
                Respecting cultural diversity is not just a matter of courtesy; it's a fundamental
                aspect of building trust and fostering inclusivity. By acknowledging and
                accommodating cultural differences, you demonstrate respect for your audience's
                backgrounds, beliefs, and values, fostering a sense of belonging and acceptance.
              </p>

              <p className='text-neutral-500 dark:text-neutral-300'>
                Websites that are culturally sensitive and inclusive provide a more meaningful and
                relevant experience for users. Tailoring your content, design, and communication to
                reflect cultural nuances can enhance user engagement, satisfaction, and loyalty.
              </p>
            </div>
          </div>
        </div>
        <div className='grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 max-w-7xl mx-auto mb-24 gap-5 px-10'>
          <div className='relative w-full text-center group flex flex-1 flex-col justify-center items-center p-10 border border-transparent rounded-lg hover:shadow-sm hover:border-gray-100 transition-all duration-300 cursor-pointer'>
            ...
            <h4 className='text-lg font-medium dark:text-white mb-3 capitalize'>
          ...
          <div className='relative w-full text-center group flex flex-1 flex-col justify-center items-center p-10  border border-transparent rounded-lg hover:shadow-sm hover:border-gray-100 transition-all duration-300 cursor-pointer'>
            ...
            <h4 className='text-lg font-medium dark:text-white mb-3 capitalize'>Data Reporting</h4>
            <p className='text-sm font-normal text-gray-500'>
        ...
        <div className='grid gap-2 lg:grid-cols-3'>
          <div className='flex flex-col justify-start border border-transparent rounded-lg hover:shadow-sm p-10 hover:border-gray-100 transition-all duration-300 cursor-pointer'>
            ...
            <p className='text-neutral-500 dark:text-neutral-300'>
              ...
              and respectful of diverse cultural backgrounds. It considers factors such as language,
              symbols, colors, imagery, and social norms to ensure that the website resonates with a
              global audience.
            </p>
          </div>
          ...
          <div className='flex flex-col justify-start border border-transparent rounded-lg hover:shadow-sm p-10 hover:border-gray-100 transition-all duration-300 cursor-pointer'>
            ...
            <p className='text-neutral-500 dark:text-neutral-300'>
              Cultural factors to consider include language preferences, cultural symbols and
              imagery, color symbolism, social norms, religious sensitivities, and regional
              preferences. Adapting these elements to align with your target audience's cultural
              context can enhance user engagement and satisfaction.
            </p>
          </div>
          ...
          <div className='flex flex-col justify-start border border-transparent rounded-lg hover:shadow-sm p-10 hover:border-gray-100 transition-all duration-300 cursor-pointer'>
            ...
            <p className='text-neutral-500 dark:text-neutral-300'>
              Using AI for cross-cultural website checks offers benefits such as automated analysis
              of large datasets, identification of cultural sensitivities, generation of actionable
              insights, and streamlining the optimization process. AI-driven tools can enhance
              efficiency and effectiveness in meeting cross-cultural requirements.
            </p>
          </div>
          ...
          <div className='flex flex-col justify-start border border-transparent rounded-lg hover:shadow-sm p-10 hover:border-gray-100 transition-all duration-300 cursor-pointer'>
            ...
            <p className='text-neutral-500 dark:text-neutral-300'>
              It's recommended to review and update your website's cross-cultural elements
              regularly, especially in response to changing cultural trends, audience feedback, and
              global events. Establishing a review schedule and staying proactive in addressing
              cultural considerations can help maintain relevance and resonance with your audience.
            </p>
          </div>
          ...
          <div className='flex flex-col justify-start border border-transparent rounded-lg hover:shadow-sm p-10 hover:border-gray-100 transition-all duration-300 cursor-pointer'>
            ...
            <p className='text-neutral-500 dark:text-neutral-300'>
              Challenges may include language barriers, cultural nuances, varying user preferences,
              technical limitations, and resource constraints. Overcoming these challenges requires
              careful planning, research, collaboration with diverse stakeholders.
            </p>
          </div>
          ...
          <div className='flex flex-col justify-start border border-transparent rounded-lg hover:shadow-sm p-10 hover:border-gray-100 transition-all duration-300 cursor-pointer'>
            ...
            <p className='text-neutral-500 dark:text-neutral-300'>
              While cross-cultural website design is particularly important for businesses with a
              global presence, it can also benefit organizations serving diverse local communities
              or targeting niche cultural demographics.
            </p>
          </div>
        </div>
      </div>

      {
        <div className='container mx-auto md:px-6'>
          <section className='mb-32 text-center'>
            <h2 className='mb-16 text-3xl font-bold'>Used AI systems</h2>
            <div className='grid grid-rows-[minmax(1fr, 200px)] gap-10 items-center grid-cols-1 sm:grid-cols-3'>
              <div className='flex flex-1 h-full justify-center'>
                <img
                  src='https://upload.wikimedia.org/wikipedia/commons/8/8a/Google_Gemini_logo.svg'
                  className='dark:brightness-70 max-h-[200px]'
                  alt='Gemini - logo'
                />
              </div>
              <div className='flex flex-1 h-full justify-center'>
                <img
                  ...
                  className='dark:brightness-60 relative max-h-[200px] dark:bg-white rounded-full p-8'
                  alt='ChatGPT - logo'
                />
              </div>
              <div className='flex flex-1 h-full justify-center'>
                <img
                  ...
                  className='dark:brightness-100 relative max-h-[200px]'
