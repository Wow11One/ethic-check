        ...
        <div>
                    ...
                    <div className="-z-10 hidden w-full md:absolute md:block   ">
                        <div className="absolute -right-6 top-[-29px]  ">
                            <div className="flex  items-center gap-1">
                                <div
                                    className="rounded-full  rounded-bl-none bg-rose-500 p-2 shadow dark:bg-rose-600/80"></div>
                                <div
                    ...
                    <div
                        ...
                        <div
                            ...
                            <p className="mx-auto max-w-md  text-center text-lg text-muted-foreground">
                                Take the first step towards creating culturally inclusive websites that resonate with
                                audiences worldwide.
                            </p>
                        </div>
                    </div>
            ...
            <div className="container my-24 mx-auto md:px-6 ">
                ...
                <section className="mb-34 text-center">
                    ...
                    <p className="mb-20">EthicCheck revolutionizes the way businesses approach cultural requirements for
                        their websites. Powered by advanced AI technology, EthicCheck delivers unparalleled accuracy and
                        efficiency in assessing cultural sensitivities. </p>
                    ...
                    <div className="grid gap-4 md:grid-cols-2">
                        ...
                        <div className="mb-6 md:mb-0">
                            ...
                            <p className="mb-12 text-neutral-500 dark:text-neutral-300">
                                EthicCheck was developed to address the critical need for cultural inclusivity in web
                                design. By ensuring that websites are culturally sensitive and inclusive, EthicCheck
                                helps businesses connect with diverse global audiences on a deeper level. Whether it's
                                language preferences, imagery, or cultural symbols, EthicCheck empowers businesses to
                                create web experiences that resonate with people from different cultural backgrounds.
                            </p>

                            <p className="mb-4 font-bold">Using AI for Cultural Insights</p>
                            <p className="mb-12 text-neutral-500 dark:text-neutral-300">
                                EthicCheck harnesses the power of AI to provide valuable feedback on websites' cultural
                                requirements. By leveraging advanced algorithms and machine learning, EthicCheck
                                analyzes website content to identify potential cultural insensitivities and provide
                                actionable insights for improvement. This innovative approach enables businesses to gain
                                deeper cultural understanding and make informed decisions about their online presence.
                            </p>
